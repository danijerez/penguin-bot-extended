...
// New Steps
#define BTN_MOONWALKRIGHT '.'
#define BTN_MOONWALKLEFT 'g'
#define BTN_PRIMERA_PARTE 'h'
#define BTN_SEGUNDA_PARTE 'j'
#define BTN_DRUNK 'k'
#define BTN_KICK_LEFT 'm'
#define BTN_KICK_RIGHT 'n'
#define BTN_DELAYS 'o'
#define BTN_WALK 'p'
#define BTN_NO_GRAVITY 'q'
#define BTN_LATERAL_FUERTE 'r'
#define BTN_SITDOWN 't'
#define BTN_LEG_RAISE 'u'
#define BTN_LEG_RAISE2 'v'
#define BTN_LEG_RAISE3 'w'
#define BTN_LEG_RAISE4 '-'
#define BTN_GOING_UP 'x'
#define BTN_BACKYARD 'y'
#define BTN_HOME 'z'
    ...
    // /*
        if (irValue != '\0')// Bluetooth serial port data stream on app side (character acquisition is completed in timer 2)
        {
            ...
            case BTN_YL_SUB:
                ...
                //Serial.println(trim_yl);
                break;
            case BTN_MOONWALKRIGHT:
                mode = MOONWALKRIGHT;
                danceFlag = true;
                break;
            case BTN_MOONWALKLEFT:
                mode = MOONWALKLEFT;
                danceFlag = true;
                break;
            case BTN_PRIMERA_PARTE:
                mode = PRIMERA_PARTE;
                danceFlag = true;
                break;
            case BTN_SEGUNDA_PARTE:
                mode = SEGUNDA_PARTE;
                danceFlag = true;
                break;
            case BTN_DRUNK:
